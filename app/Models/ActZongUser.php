...
class ActZongUser extends Model
{
    //活动一用户数据表
    use SoftDeletes;
    protected $dates = ['deleted_at'];
    protected $table = 'act_zong_user';
    protected $primaryKey = 'id';
    protected $fillable = ['id','member_id','has_flag','has_reward','flag_num','activity_id','address','status','award','delivery','cost'];
