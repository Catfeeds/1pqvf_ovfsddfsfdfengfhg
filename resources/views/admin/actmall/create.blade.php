    ...
    <article class="page-container">
        <form action="{{ url('admin/actmall')  }}" method="post" enctype="multipart/form-data"  class="form form-horizontal" id="form-actmall-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"  placeholder="商品价格" id="price" name="price">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text"  placeholder="商品数量" id="act_num" name="act_num">
                </div>
            </div>
            <div class="row cl">
