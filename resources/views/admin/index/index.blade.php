...
@section('content')
	...
	<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="javascript:void(0)">跑券后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/admin/index">H-ui</a>
	...
	<li><a data-href="{{ url ( 'admin/member' ) }}" data-title="会员列表" href="javascript:;">会员列表</a></li>
		...
		<li><a data-href="{{ url ( 'admin/dynamic' ) }}" data-title="动态管理" href="javascript:;">动态管理</a></li>
	</ul>
	</dd>
	</dl>
	<dl id="menu-admin">
	...
	<li><a data-href="{{ url('admin/admin')  }}" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{ url('admin/ification')  }}" data-title="商家分类列表" href="javascript:void(0)">商家分类列表</a></li>
					<li><a data-href="{{ url('admin/appraise')  }}" data-title="评价列表" href="javascript:void(0)">评价列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{ url('admin/picture')  }}" data-title="优惠券图片管理" href="javascript:void(0)">优惠券图片管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('admin/intMall')  }}" data-title="积分商城列表" href="javascript:void(0)">积分商城列表</a></li>
					<li><a data-href="{{ url('admin/theDelivery')  }}" data-title="积分商品发货" href="javascript:void(0)">积分商品发货</a></li>
					<li><a data-href="{{ url('admin/subject')  }}" data-title="话题分类列表" href="javascript:void(0)">话题分类列表</a></li>
					<li><a data-href="{{ url('admin/topic')  }}" data-title="话题管理" href="javascript:void(0)">话题管理</a></li>
					<li><a data-href="{{ url('admin/actmall')  }}" data-title="活动商城列表" href="javascript:void(0)">活动商城列表</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('admin/activity')  }}" data-title="活动列表" href="javascript:void(0)">活动列表</a></li>
		...
		<dl id="menu-admin">
			<dt><i class="Hui-iconfont comment">&#xe622;</i> 评论<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
