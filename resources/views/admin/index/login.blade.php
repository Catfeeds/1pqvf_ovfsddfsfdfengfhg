...
<![endif]-->
  {{-- layer --}}
  <link href="{{ asset('admin') }}/lib/layer/2.4/skin/layer.css" rel="stylesheet" type="text/css" />

  <title>跑券后台管理系统</title>
<meta name="keywords" content="跑券后台管理系统">
<meta name="description" content="跑券后台管理系统">
</head>
<body>
    ...
    <form class="form form-horizontal" action="{{ url('admin/login')  }}" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{  captcha_src('flat') }}" id="captcha" > <a id="kanbuq" onclick="$('#captcha').attr('src','{{ captcha_src('flat') }}'+(new Date()-0))" href="javascript:;">看不清，换一张</a> </div>
      </div>
...
<div class="footer">
  copy© 易息通达网络科技有限公司
  <img src="{{ asset('admin')  }}/images/logo.png" style="width: 35px;" alt="">
</div>
