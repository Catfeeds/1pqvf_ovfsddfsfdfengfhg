...
<body>
<svg id="robot" version="1.1" x="0" y="0" width="320px" height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
    <rect x="59.722" y="72.779" fill="#333" width="40.557" height="27.564"></rect>
    <g id="head" class="up">
        <g id="leftAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 77.519 25.869 C 75.85 13.604 65.745 3.39 53.972 3.35276">
            ...
            <ellipse fill="#ccc" cx="55.021" cy="3.35276" rx="3.344" ry="3.391">
        ...
        <g id="rightAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 82.48 25.869 C 84.15 13.604 94.255 3.39 106.028 8.6641">
            ...
            <ellipse fill="#ccc" cx="104.979" cy="8.6641" rx="3.344" ry="3.391">
    ...
    C118.309,65.694,118.625,47.035,112.809,28.372z"></path>
        <g>
            <g id="eyeLeft">
                <path fill="#FFFFFF" d="M 72.116 47.955 c 0 5.443 -3.80642 9.853 -9.033 9.853 h -1.971 c -4.988 0 -9.032 -4.41 -9.032 -9.853 s 4.044 -9.55777 9.032 -9.55777 h 1.971 C 68.071 38.5165 72.116 42.512 72.116 47.955 Z">
        ...
        c0-2.178,1.618-3.943,3.612-3.943H63C64.996,44.012,66.614,45.777,66.614,47.955z"></path>
            ...
            <g>
                <path fill="#FFFFFF" d="M 107.92 47.955 c 0 5.443 -4.045 9.853 -9.031 9.853 h -1.973 c -4.986 0 -9.031 -4.41 -9.031 -9.853 s 4.045 -9.55777 9.031 -9.55777 h 1.973 C 103.875 38.5165 107.92 42.512 107.92 47.955 Z">
                    <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s" dur="0.8s" repeatCount="indefinite" values="
        ...
        <path fill="#FFFFFF" d="M 103.383 69.778 c 0 1.381 -0.858172 2.70686 -1.871 2.499 c -11.2318 -2.31509 -30.1322 -2.03332 -43.025 0 c -1.02007 0.157973 -1.871 -1.118 -1.871 -2.499 c 0 -1.378 0.886038 -2.79439 1.871 -2.496 c 14.8531 4.61447 30.5692 3.17146 43.025 0 C 102.514 67.0307 103.383 68.4 103.383 69.778 Z">
...
<div style="text-align:center;clear:both">
    <script src="/gg_bd_ad_720x90.js" type="text/javascript"></script><div style="width:970px;margin:10px auto;">
        <script async="" src=""></script>
        <!-- html5tricks-demo-big -->
        <ins class="adsbygoogle" style="display:inline-block;width:970px;height:250px" data-ad-client="ca-pub-4188263447419139" data-ad-slot="5506515209" data-adsbygoogle-status="done"><ins id="aswift_0_expand" style="display:inline-table;border:none;height:250px;margin:0;padding:0;position:relative;visibility:visible;width:970px;background-color:transparent;"><ins id="aswift_0_anchor" style="display:block;border:none;height:250px;margin:0;padding:0;position:relative;visibility:visible;width:970px;background-color:transparent;"><iframe width="970" height="250" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allowfullscreen="true" onload="var i=this.id,s=window.google_iframe_oncopy,H=s&amp;&amp;s.handlers,h=H&amp;&amp;H[i],w=this.contentWindow,d;try{d=w.document}catch(e){}if(h&amp;&amp;d&amp;&amp;(!d.body||!d.body.firstChild)){if(h.call){setTimeout(h,0)}else if(h.match){try{h=s.upd(h,i)}catch(e){}w.location.replace(h)}}" id="aswift_0" name="aswift_0" style="left:0;position:absolute;top:0;width:970px;height:250px;"></iframe></ins></ins></ins>
        <script>
...
<div class="col">
    <h1>404</h1>
    <h2><a href="/" style="color: #FFFFFF">返回首页</a></h2>
</div>
